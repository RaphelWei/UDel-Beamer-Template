...
\addtobeamertemplate{frametitle}{}{
    \begin{textblock*}{100mm}(.93\textwidth,6.5cm)
        \includegraphics[height=1.2cm]{./Figures/logo/logo.jpg}
    \end{textblock*}
}
\addtobeamertemplate{frametitle}{}{
    \begin{textblock*}{100mm}(.87\textwidth,-.9cm)
        \includegraphics[height=.85cm]{./Figures/logo/logo3.png}
    \end{textblock*}}
\definecolor{themecolor}{RGB}{0,83,159}
\mode<presentation>
{
